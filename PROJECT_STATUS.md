...
**Summary:** Fixed timezone bug. Added a timezone field to the User profile, and updated all date calculations (dashboard, streaks) to use the user's specific timezone instead of the server's default timezone.
...
- Basic feature tests cover:
  ...
  - Verifying habit timezone streak calculation and dashboard display.
