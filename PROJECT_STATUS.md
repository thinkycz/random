...
**Summary:** Added Timezone support. The app now handles timezone conversion on the server correctly according to the user's saved timezone preference in their profile. Users can select their timezone and the app calculates "today" appropriately for daily completions and streak evaluation.
...
- Added user timezone support to handle logic accurately across the globe.
...
- Basic feature tests cover:
  ...
  - Timezone testing correctly evaluating habit completeness against users' local timezone.
- Test coverage is good. Timezone edge cases have been resolved and covered.
