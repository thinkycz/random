...
**Summary:** Implemented user timezone handling. Users can now set their timezone in their profile, and the application uses this to correctly determine "today" on the dashboard, when toggling habit completions, and when calculating streaks.
...
- Implemented user timezone handling via a profile setting and updated dates/streaks to respect it.
