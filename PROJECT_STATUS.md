...
**Summary:** Added Timezone support. Users can now set their timezone in their profile settings. Dashboard and Streak calculations now properly respect the user's timezone instead of the server's timezone.
...
- Implemented user timezone selection and integrated it across habit tracking and streak logic.
...
- Basic feature tests cover:
  ...
  - Timezone functionality mapping correctly on dashboard display and toggling.
- Test coverage is moderate. Edge cases, like timezone issues, are now tested.
