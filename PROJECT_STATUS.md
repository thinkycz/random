...
**Summary:** Fixed the timezone bug by adding a timezone field to the user profile and using the user's selected timezone when determining "today", "yesterday", and calculating streaks.
...
- Fixed the Timezone bug by allowing users to set their timezone in their profile, and respecting it during streak calculations and dashboard interactions.
