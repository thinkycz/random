...
**Summary:** Implemented user timezone handling. Users can now select their timezone in their profile, and the application appropriately adjusts "today", "yesterday", streak calculations, and completions to align with their local timezone rather than UTC.

## What has been completed
- Added `timezone` field to `users` table and profile forms.
- Updated Habit controllers and models to respect user's timezone.
