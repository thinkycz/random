...
**Summary:** Added timezone handling to the application. Users can now set their timezone in their profile. Habit completions and streak calculations respect the user's selected timezone rather than the server default.
...
- Added client-side timezone handling based on user profiles.
...
- Basic feature tests cover:
  ...
  - Timezone functionality logic for dashboards and toggles.
