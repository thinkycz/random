...
**Summary:** Added user timezone settings. Users can now set their timezone in their profile. Habit completion toggling, dashboards, and streak logic have been updated to accurately reflect "today" relative to the user's specific local timezone rather than the server's.
...
- Allowed users to set their timezone in their profile to fix date boundary issues.
...
- Test coverage is moderate. Edge cases like timezone boundaries are now tested.
