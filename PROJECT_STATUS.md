...
**Summary:** Implemented user timezone support. Users can now select their local timezone on their Profile page, and all dashboard date calculations and streak tracking are calculated correctly relative to their timezone instead of relying on the server's UTC time.
...
- Implemented user-specific timezone handling for dashboard and streak calculations.
