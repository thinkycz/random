...
**Summary:** Fixed the timezone bug by allowing users to set their timezone in their profile. Habit completion tracking and streak calculations now respect the user's specific timezone instead of falling back to the server time.
...
- Allowed users to specify their timezone and made habit logic respect the user's timezone.
...
- Basic feature tests cover:
  ...
  - Timezone calculations using fake UTC/Local offsets.
