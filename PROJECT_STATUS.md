...
**Summary:** Fixed the timezone bug. Added a `timezone` field to the users table (selectable in the Profile page) and updated the dashboard, habit toggling, and streak calculations to use the user's selected timezone.
...
- Added user timezone settings and timezone-aware habit tracking.
