...
**Summary:** Added timezone support for users. Users can now select their timezone in their profile, and habit completion dates/streaks will accurately reflect their local timezone instead of the server's UTC time.
...
- Added user timezone selection in the profile settings.
- Updated Habit completion and streak calculations to respect the user's timezone.
...
- Basic feature tests cover:
  ...
  - Timezone-specific habit completion handling.
