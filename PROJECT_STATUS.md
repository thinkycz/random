...
**Summary:** Implemented User Timezone Support. Added a timezone field to the users table and profile form. Habit "today" and "yesterday" logic (including streaks and dashboard completions) now accurately respects the user's local timezone instead of defaulting to the server's UTC time.
...
- Added user timezone support, ensuring accurate completion tracking across different geographical locations.
...
- Basic feature tests cover:
  ...
  - Timezone calculations and boundaries.
