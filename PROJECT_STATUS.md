...
**Summary:** Added user-specific timezone support. Users can now select their timezone in their profile. Habit completion toggles, dashboard display, and streak calculations now all correctly use the user's localized timezone instead of the server's UTC time.
...
- Added user-specific timezone handling to fix bugs related to "today" calculation.
