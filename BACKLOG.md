...
## Refactoring Ideas
- **[Medium] Service Classes:** If the completion logic (toggling, streaks) becomes complex, extract it into a `HabitCompletionService` rather than keeping it in the controller.
