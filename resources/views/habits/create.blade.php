        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('habits.store') }}" class="mt-6 space-y-6 max-w-xl">
                        @csrf
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('habits.index') }}" class="text-gray-600 hover:text-gray-900 text-sm">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
