...
class HabitTest extends TestCase
{
    ...
    public function test_streak_calculation_with_timezone()
    {
        ...
        // Mock current time to be 10:00 PM in UTC (which is 5:00 PM or 6:00 PM depending on DST in NY).
        // Let's set a specific date so we can predict the boundary
        $testDateUtc = \Carbon\Carbon::create(2026, 3, 10, 2, 0, 0, 'UTC'); // 2 AM UTC on March 10
        // In NY, this is 9 PM or 10 PM on March 9th!
        \Carbon\Carbon::setTestNow($testDateUtc);

        $nyTime = now('America/New_York');
        $this->assertEquals('2026-03-09', $nyTime->format('Y-m-d'));

        // Complete the habit on "March 9th"
        ...
        // Because to the NY user, today is March 9th, and they completed it on March 9th, current streak should be 1.
